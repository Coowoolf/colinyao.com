...
await p.goto("http://localhost:3000/cowork-conf#1", { waitUntil: "networkidle" });
...
for (let n = 1; n <= N; n++) {
  ...
  if (CHANGED.includes(n)) await p.screenshot({ path: `/tmp/confshots/c${String(n).padStart(2, "0")}.png` });
}
