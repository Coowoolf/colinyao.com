...
// 用法：node scripts/shot-postloan.mjs                （light · 全 15 页 + contact sheet）
...
const OUT = process.env.OUT || '/home/claude/eco-review/postloan-shots-' + THEME;
...
if (FULL) {
  ...
  const dst = `/home/claude/eco-review/postloan-contact-${THEME}.png`;
