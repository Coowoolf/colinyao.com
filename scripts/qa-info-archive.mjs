...
const must=['No.1','100万+','900亿+','50+','96.5%','2,475',
  ...
  'ONE REAL-TIME NET','三种互动 · 由内向外生长',
  '人 · 人与人','智能体 · 人与智能体','智能体网 · 智能体与智能体','互动流','标注引线',
  '同一张实时网，服务人与人、人与智能体、智能体与智能体。',
  '近一半','IDC','650','340','95%','200+','毫秒级','30000+',
  '声网官方联合案例 · 均已公开——你的场景，多半能对上号。',
  // v3.4（2026-09-06）：P8 细节层的 Google 背书与补过来源的 SOURCE 行 —— 归档件是
  //   直接发给客户的那一份，这两句必须跟着烘进去（措辞逐字，一手来源见 builder 头注）。
  '2026 Google Gemini 3.5 Transcribe 发布 · 声网为官方博文点名的开发者平台 · '
    + '引擎已接入 Gemini ASR（早期预览）。',
