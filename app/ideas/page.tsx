...
export const metadata: Metadata = {
  title: "Ideas · 概念库",
  description:
    "姚光华（Colin）的概念库：同一把尺子、活人感、被记住·被托付、模型上限·引擎下限、Vibe SOTA、QoI、听得到→听得心、0.29TB。每个概念都有定义与出处。",
};
      ...
      <div className="wrap">
        <Reveal className="section-head">
          ...
          <p className="lead flow" style={s(2)}>
            没被命名的直觉留不下来。这 {ideas.length} 个概念是两年 15 场演讲淘出来的思考工具——
            每一个都有定义、有出处、有它长出来的那场演讲。引用随意，注明 colinyao.com 即可。
          </p>
        </Reveal>
