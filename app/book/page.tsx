...
export const metadata = {
  title: "书 · 封面与总目录",
  description: "《同一把尺子》——姚光华 Colin 著。五卷四十篇 1347 页，论证的顺序：尺子、活人感、被托付、同源进化、内观。合上态；展开是时空内外。",
};
      ...
      <section className="section" id="toc">
        <div className="wrap">
          ...
          <Reveal className="toc">
            ...
            <Link href="/toc#timeline" className="toc-row appendix flow" style={s(6)}>
            ...
            <Link href="/toc#terms" className="toc-row appendix flow" style={s(7)}>
