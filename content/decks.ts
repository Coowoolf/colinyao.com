...
export const speechDecks: Deck[] = [
  ...
  // 2026-08-20：扩为 16 页 —— 补 P3 双工三模式 / P4 全双工工作原理 / P7 VAD 三张机理页。
  // 重建：python3 scripts/build-convoai-engine.py（双生同写 /decks/convoai-engine.html 别名，抽屉 iframe 指它）
  // 自检：node scripts/qa-convoai-engine.mjs（THEME=dark 二跑，含双生一致闸 + P16 口径锁 + P8 大图闸）
  { slug: "convoai", title: "声网 · 对话式 AI 引擎 · 产品介绍", slides: 17, category: "演讲", dual: true },
