...
/** Idea 卡片母题图（一图胜千言：线条自绘入场 + 持续流动光点/呼吸点，卡片永远是活的） */
export default function Motif({ kind }: { kind: string }) {
  switch (kind) {
    case "ruler":
      return (
        <svg viewBox="0 0 220 64" fill="none" aria-hidden="true">
          ...
          <path className="mlive" d="M12 36 H208" stroke="var(--coral)" strokeWidth="1.6" opacity=".8" />
    ...
    case "wave":
      return (
        <svg viewBox="0 0 220 64" fill="none" aria-hidden="true">
          ...
          <path className="mlive" d="M84 32 C 90 32, 92 18, 98 18 S 106 44, 112 44 S 120 10, 126 10 S 134 50, 140 50 S 148 22, 154 22 S 160 36, 166 32 H212"
            stroke="#fffffe" strokeWidth="1.6" opacity=".7" />
          <path className="dw" style={v(50, 5)} d="M166 32 H212" stroke="var(--amber)" strokeWidth="1.8" strokeLinecap="round" />
          <circle className="pop dlive" style={p(6)} cx="212" cy="32" r="3.5" fill="var(--amber)" />
        </svg>
      );
    case "hemis":
      return (
        <svg viewBox="0 0 220 64" fill="none" aria-hidden="true">
          ...
          <circle className="mlive slow" cx="62" cy="30" r="21" stroke="var(--amber)" strokeWidth="1.5" opacity=".9" />
          <circle className="mlive slow" cx="158" cy="30" r="21" stroke="var(--coral)" strokeWidth="1.5" opacity=".9" />
          <path className="dw" style={v(40, 4)} d="M83 30 H137" stroke="var(--hair-strong)" strokeWidth="1.2" />
          <circle className="pop dlive" style={p(5)} cx="110" cy="30" r="4.5" fill="var(--amber)" />
    ...
    case "bounds":
      return (
        <svg viewBox="0 0 220 64" fill="none" aria-hidden="true">
          ...
          <path className="mlive" d="M12 50 H208" stroke="#fffffe" strokeWidth="1.6" opacity=".55" />
    ...
    case "sota":
      return (
        <svg viewBox="0 0 220 64" fill="none" aria-hidden="true">
          ...
          <path className="dw dlive" style={v(60, 5)} d="M138 54 V14" stroke="var(--amber)" strokeWidth="7" />
          <path className="dw" style={v(60, 7)} d="M160 24 L200 24" stroke="var(--hair-strong)" strokeWidth="1.2" strokeDasharray="3 5" />
          <path className="mlive slow" d="M30 54 V40 M66 54 V32 M102 54 V24 M138 54 V14" stroke="#fffffe" strokeWidth="2" opacity="0" />
    ...
    case "qoi":
      return (
        <svg viewBox="0 0 220 64" fill="none" aria-hidden="true">
          ...
          <path className="mlive" d="M12 54 H70 V38 H140 V20 H208" stroke="var(--amber)" strokeWidth="1.8" opacity=".9" />
    ...
    case "steps":
      return (
        <svg viewBox="0 0 220 64" fill="none" aria-hidden="true">
          ...
          <path className="mlive" d="M14 52 C 60 50, 120 40, 206 14" stroke="var(--amber)" strokeWidth="1.5" opacity=".85" />
          ...
          <circle className="pop dlive" style={p(6)} cx="206" cy="14" r="5" fill="var(--amber)" />
    ...
    case "tb":
      return (
        <svg viewBox="0 0 220 64" fill="none" aria-hidden="true">
          <circle className="dw" style={v(160, 2)} cx="32" cy="32" r="22" stroke="var(--amber)" strokeWidth="1.6" />
          <circle className="mlive slow" cx="32" cy="32" r="22" stroke="#fffffe" strokeWidth="1.4" opacity=".7" />
          <circle className="pop dlive" style={p(4)} cx="32" cy="32" r="4" fill="var(--amber)" />
          <text className="pop" style={p(3)} x="70" y="42" fill="var(--amber)" fontFamily="var(--mono)" fontSize="30" fontWeight="700" letterSpacing="-0.5">0.29 TB</text>
        </svg>
      );
    default:
      return null;
